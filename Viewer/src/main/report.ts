...
let achievements: Record<string, GTFOAchievement> = {
    ...
    "imposter": {
        ...
        award: function(report: GTFOReport)
        {
            let calcTeamDamage = function(player: GTFOPlayerData): number
            {
                let damage = 0;
    ...
    "MVP": {
        ...
        award: function(report: GTFOReport)
        {
            let calcDamage = function(player: GTFOPlayerData): number
            {
                let damage = 0;
                for (let g in player.gears)
                {
    ...
    "angel": {
        ...
        award: function(report: GTFOReport)
        {
            let calcRevives = function(player: GTFOPlayerData): number
            {
                let count = 0;
    ...
    "support": {
        ...
        award: function(report: GTFOReport)
        {
            let calcAssists = function(player: GTFOPlayerData): number
            {
                let assists = 0;
                for (let g in player.gears)
                {
    ...
    "killstealer": {
        ...
        award: function(report: GTFOReport)
        {
            ...
            let calcKills = function(player: GTFOPlayerData): number
            {
                let kills = 0;
                for (let g in player.gears)
                {
    ...
    "sleepy": {
        ...
        award: function(report: GTFOReport)
        {
            let calcTimeDown = function(player: GTFOPlayerData): number
            {
                let time = 0;
...
interface GTFODodgeEvent extends GTFOEvent
{
    type: string;
    enemyInstanceID: string;
}

interface GTFOPackUseEvent extends GTFOEvent
{
    type: string;
    playerID?: string;
}

interface GTFODamageEvent extends GTFOEvent
{
    type: string;
    damage: number;
...
interface GTFOHealthEvent extends GTFOEvent
{
    value: number;
}

interface GTFOInfectionEvent extends GTFOEvent
{
    value: number;
}

interface GTFOPlayerStateEvent extends GTFOEvent
{
    type: string;
    playerID?: string;
}
...
interface GTFOEventWrapper
{
    type: "state" | "damage" | "packs";
    event: GTFOEvent;
}
...
interface GTFOPlayerData
{
    ...
    packsTimeline: GTFOPackUseEvent[];
    timeline: GTFOEventWrapper[];
